    ...
    $(document).on("click", ".show-delete-modal", function (e) {
        ...
        switch (act)
        {
            case "ban":
                ...
                break;
            case "delete":
                message = "Admin ကို အပြီးအပိုင် ဖျက်ပစ်ပါမည်။ ဆက်လက် လုပ်ဆောင်ပါမည်လား ?"
                break;
            case "restore":
                message = "Admin ကိုပြန်လည်ခွင့်ပြုပါမည်။ ဆက်လက်လုပ်ဆောင်ပါမည်လား ?"
                break;
            default:
                message = "ဤလုပ်ဆောင်ချက်ကို ပြန်ပြင်၍မရပါ။ ဆက်လက် လုပ်ဆောင်ပါမည်လား ?"
        }
