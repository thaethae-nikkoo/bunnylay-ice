...
<div class="container-xxl flex-grow-1 container-p-y">
    <h6 class="fw-bold mb-4"><span class="fw-light">အသုံးပြုသူများ /</span>
        {{__('template_names.edit_title_text')}} </h6>
    <div class="card">
        <form action="{{route('adminUpdate', $_resource->admin_id)}}" method="POST" id="kt_stepper_form">
            @csrf
            @method('PATCH')
            <div class="card-body">
                ...
                <div class="card-action mt-3">
                    ...
                    <a href="{{route('adminLists')}}" class="btn btn-sm btn-secondary">ပြန်ထွက်
