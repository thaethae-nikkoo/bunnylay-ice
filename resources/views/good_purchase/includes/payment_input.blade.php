                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="good_purchase_id" id="good_purchase_id">
                            <input type="hidden" name="subject" id="subject">
                            <div class="col-12 mb-3">
                                <label for="amount" class="form-label">အမောင့် (ကျပ်) <span
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="saveBtn" class="btn btn-primary">{{ __('template_names.save_btn_text') }}</button>
                    </div>
                </div>
            </div>
        </div>
