...
@let($goodSalePaymentId = $_resource->good_sale_payment_id ?? null)
@php
...
<div class="row">
    ...
    <div class="col-md-6 col-sm-12 mb-3">
        ...
        <input type="text" class="form-control shadow-none" name="description" id="description" {{$isEdit && !empty($goodSalePaymentId) ? 'readonly' : ''}}
    ...
    <div class="col-md-6 col-sm-12 mb-3 only-number">
